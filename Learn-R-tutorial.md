...
Before we begin producing R code, we need to familiarize ourselves with where work is going to be located on our computers.To find out type in the console `getwd()` command. This will promt R to print out a path to a location on your computer where any scripts, plots, data you generate will be saved.
