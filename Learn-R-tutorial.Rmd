...
So, where is my R work (scripts, plots) going to exist? To find out type in the console `getwd()` command. This will promt R to print out a path to a location on your computer where any scripts, plots, data you generate will be saved.
...
R projects allows you to maintain everything related to your analysis in a single location. To create a new project in RStudio:
...
1. Create an Rproject (File>New Project>...) called “R-beginner-workshop”
2. Create a folder called Data
3. Put the Crime.csv into folder Data
[4. Create a script called “R-beginner-scripts” - introduce script!]
