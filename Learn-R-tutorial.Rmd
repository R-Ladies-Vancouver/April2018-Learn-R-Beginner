...
* Data sorting, cleaning, organizing, tidying, transforming - part of [data WRANGLING]()
...
* Bioinformatics, e.g. bioconductor package]()
* Interactive web applications - they are called [RShiny apps]() and allow you to build plots that users can explore interactively. Fantastic tool for sharing/communicating your data analysis 
* And another great tool for sharing analysis is [RMarkdown](), in RMarkdown documents you can embedd R code and
